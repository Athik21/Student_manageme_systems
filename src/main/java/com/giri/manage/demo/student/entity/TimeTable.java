...
public class TimeTable {
	...
	public String toString() {
		return "TimeTable [id=" + id + ", days=" + days + ", hour1=" + hour1 + ", hour2=" + hour2 + ", hour3=" + hour3
	...
	public TimeTable(int id, String days, String hour1, String hour2, String hour3, String hour4, String hour5,
