...
import com.giri.manage.demo.student.service.impl.ExcelFinal;
import com.giri.manage.demo.student.service.impl.ExcelThird;

@Service
public class ExcelUploadFinal implements ExcelFinal {

	@Value("${app.upload.file4:${user.home}}")
	public String EXCEL_FILE_PATH;

	@Autowired
	StudentRepo_final_year repo;

	Workbook workbook;


	public List<FinalYear> getExcelDataAsList() {
		...
		List<FinalYear> invList = createList(list, noOfColumns);
	...
	private List<FinalYear> createList(List<String> excelData, int noOfColumns) {

		ArrayList<FinalYear> invList = new ArrayList<FinalYear>();

		int i = noOfColumns;
		do {
			FinalYear inv = new FinalYear();
	...
	@Override
	public int saveExcelData(List<FinalYear> invoices) {
		System.out.println("final saved");
